-- ORDERS
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.ORDERS (
    ORDER_ID VARCHAR,
    USER_NAME VARCHAR,
...
-- ORDER_ITEMS
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.ORDER_ITEMS (
    ORDER_ID VARCHAR,
...
-- USERS
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.USERS (
    USER_NAME VARCHAR,
...
-- SELLERS
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.SELLERS (
    SELLER_ID VARCHAR,
...
-- PRODUCTS
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.PRODUCTS (
    PRODUCT_ID VARCHAR,
...
-- PAYMENTS
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.PAYMENTS (
    ORDER_ID VARCHAR,
...
-- FEEDBACK
CREATE OR REPLACE TABLE ECOMMERCE_DW.SILVER.FEEDBACK (
    FEEDBACK_ID VARCHAR,
    ORDER_ID VARCHAR,
